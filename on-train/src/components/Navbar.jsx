  ...
  return (
    <div className="navbar  bg-white border-2 border-blue-200 h-18 rounded-md">
      ...
      <div className="flex-none">
        <Link to="/about" className=" px-4 text-lg font-semibold hover:text-blue-700 text-black">Book a Ticket</Link>
        <Link to="/about" className="pl-4 pr-20 text-lg hover:text-blue-700 font-semibold text-black">Orders</Link>
        <div className="dropdown dropdown-end pr-10">
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
            <div className="w-28 rounded-full hover:scale-110">
              <img
                alt="User Profile"
                src={isLoggedIn ? profilePic : "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg"} />
            </div>
          </div>
          <ul
            tabIndex={0}
